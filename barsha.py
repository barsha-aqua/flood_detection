...
print("Training Time:", gpu_train_time, "seconds")
print(classification_report(y_test, y_pred_rf))

start_xgb = time.time()

xgb_model = xgb.XGBClassifier(
    tree_method='hist',  # Fast gpu method
...
times = [gpu_train_time, xgb_train_time, lr_train_time]
